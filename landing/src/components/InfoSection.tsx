...
export const InfoSection: React.FC = () => {
  return (
    <section className="bg-[#F0F9FF] px-6 py-28" id="map-view">
      <div className="max-w-[88rem] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <ScrollReveal delay={1} className="relative lg:col-span-2 rounded-3xl overflow-hidden min-h-[360px] p-8 flex flex-col justify-between shadow-md group hover:shadow-lg transition-all duration-300 cursor-pointer border border-brand-500/10"
          >
            {/* Background Image */}
            <img 
          ...
          <ScrollReveal delay={2} className="bg-[#1E293B] rounded-3xl p-8 min-h-[360px] flex flex-col justify-between shadow-md hover:shadow-xl hover:translate-y-[-4px] transition-all duration-300 cursor-pointer group border border-brand-500/20">
            <div className="bg-brand-500/15 w-12 h-12 rounded-2xl flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform duration-300">
          ...
          <ScrollReveal delay={3} className="bg-[#1E293B] rounded-3xl p-8 min-h-[360px] flex flex-col justify-between shadow-md hover:shadow-xl hover:translate-y-[-4px] transition-all duration-300 cursor-pointer group border border-brand-500/20">
            <div className="bg-brand-500/15 w-12 h-12 rounded-2xl flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform duration-300">
