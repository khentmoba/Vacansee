...
- 002-github-vercel-cicd: Added Dart 3.10+ / Flutter 3.13+ (Web) + Vercel CLI (v30+), Flutter Action (Subosito)

- 001-owner-property-management: Added [e.g., Python 3.11, Swift 5.9, Rust 1.75 or NEEDS CLARIFICATION] + [e.g., FastAPI, UIKit, LLVM or NEEDS CLARIFICATION]
