      ...
      _value.copyWith(
            totalProperties: null == totalProperties
                ...
                : totalProperties // ignore: cast_nullable_to_non_nullable
                      as int,
            verifiedProperties: null == verifiedProperties
                ? _value.verifiedProperties
                : verifiedProperties // ignore: cast_nullable_to_non_nullable
                      as int,
            totalOwners: null == totalOwners
                ? _value.totalOwners
                : totalOwners // ignore: cast_nullable_to_non_nullable
                      as int,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.verifiedProperties, verifiedProperties) ||
                other.verifiedProperties == verifiedProperties) &&
            (identical(other.totalOwners, totalOwners) ||
...
abstract class _AdminStatsModel implements AdminStatsModel {
  const factory _AdminStatsModel({
    required final int totalProperties,
